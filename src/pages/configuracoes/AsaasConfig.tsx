...
export function AsaasConfig({ onBack }: Props) {
  ...
  const webhookUrl = "https://ugvmbtufwtpfqmvfmsde.supabase.co/functions/v1/asaas-webhook";
            ...
            <div className="flex gap-3">
              ...
              <div className="space-y-2 text-sm">
                ...
                <ol className="list-decimal list-inside space-y-1.5 text-muted-foreground leading-relaxed">
                  ...
                  <li>Ative <span className="text-foreground font-medium">todos os eventos</span> de Cobranças, Assinaturas e PIX</li>
